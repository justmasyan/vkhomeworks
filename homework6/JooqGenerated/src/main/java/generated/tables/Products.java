...
public class Products extends TableImpl<ProductsRecord> {
     ...
     */
    public final TableField<ProductsRecord, String> TITLE = createField(DSL.name("title"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.products.variety</code>.
     */
    public final TableField<ProductsRecord, String> VARIETY = createField(DSL.name("variety"), SQLDataType.VARCHAR(50).nullable(false), this, "");
