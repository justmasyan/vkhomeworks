            ...
            while (true) {
                ...
                switch (command) {
                    ...
                    case "-addInvoice" -> {
                        ...
                        InvoiceInfo invoiceInfo = new InvoiceInfo(Date.valueOf(scanner.next()).toLocalDate(), scanner.nextInt());
                    ...
                    case "-priceBetterThan" -> {
                        ...
                        System.out.println(DAO.priceBetterThan(DataBaseInitializer.DEFAULT, new BigDecimal(scanner.nextInt())));
                    }
                    case "-allProductsAmountAndSum" -> {
                        ...
                        System.out.println(DAO.allProductsAmountAndSum(DataBaseInitializer.DEFAULT, Date.valueOf(scanner.nextLine()).toLocalDate(), Date.valueOf(scanner.nextLine()).toLocalDate()));
                    }
                    case "-averagePriceProduct" -> {
                        System.out.println("Input the start and end dates of the period on two different lines. Format(yyyy-mm-dd)");
                        System.out.println(DAO.averagePriceProduct(DataBaseInitializer.DEFAULT, Date.valueOf(scanner.nextLine()).toLocalDate(), Date.valueOf(scanner.nextLine()).toLocalDate()));
                    }
                    case "-productsFromAllOrganization" -> {
                        System.out.println("Input the start and end dates of the period on two different lines. Format(yyyy-mm-dd)");
                        System.out.println(DAO.productsFromAllOrganization(DataBaseInitializer.DEFAULT, Date.valueOf(scanner.nextLine()).toLocalDate(), Date.valueOf(scanner.nextLine()).toLocalDate()));
                    }
                }
            }
