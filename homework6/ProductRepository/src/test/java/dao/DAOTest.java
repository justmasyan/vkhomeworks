...
class DAOTest {
    ...
    void priceBetterThan() {
        BigDecimal exceptedAmount = new BigDecimal(50);
        Map<String, List<String>> exceptedMap = new HashMap<>();
    ...
    void allProductsAmountAndSum() {
        LocalDate exceptedStartPeriod = Date.valueOf("1910-01-01").toLocalDate();
        LocalDate exceptedFinishPeriod = Date.valueOf("1920-01-01").toLocalDate();
        ...
        Map<String, List<Integer>> actualMap = DAO.allProductsAmountAndSum(testDatabase, exceptedStartPeriod, exceptedFinishPeriod);
        Assertions.assertEquals(exceptedMap, actualMap);
    }

    @Test
    void averagePriceProduct() {
        LocalDate exceptedStartPeriod = Date.valueOf("1910-01-01").toLocalDate();
        LocalDate exceptedFinishPeriod = Date.valueOf("1914-01-01").toLocalDate();
        ...
        Assertions.assertEquals(exceptedMap, DAO.averagePriceProduct(testDatabase, exceptedStartPeriod, exceptedFinishPeriod));
    }

    @Test
    void productsFromAllOrganization() {
        LocalDate exceptedStartPeriod = Date.valueOf("1910-01-01").toLocalDate();
        LocalDate exceptedFinishPeriod = Date.valueOf("1916-01-01").toLocalDate();
        ...
        array = new String[]{"potatowild", "tomatored"};
        exceptedMap.put("FunnyArbuser", Arrays.asList(array));
        array = new String[]{"potatowild", "orangesoranges", "applesgreen", "tomatored"};
        exceptedMap.put("VotchinaLogus", Arrays.asList(array));
